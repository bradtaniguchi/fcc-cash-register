...
describe('checkCashRegister', () => {
  ...
  test.only('checkCashRegister(19.5, 20, [["PENNY", 0.01], ["NICKEL", 0], ["DIME", 0], ["QUARTER", 0], ["ONE", 1], ["FIVE", 0], ["TEN", 0], ["TWENTY", 0], ["ONE HUNDRED", 0]]) should return {status: "INSUFFICIENT_FUNDS", change: []}.', () =>
    expect(
      checkCashRegister(19.5, 20, [
        ['PENNY', 0.01],
        ['NICKEL', 0],
